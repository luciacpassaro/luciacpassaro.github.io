...
* Pablo Ferri, Vincenzo Lomonaco, **Lucia C. Passaro**, Antonio Félix-De Castro, Purificación Sánchez-Cuesta, Carlos Sáez, Juan M. García-Gómez: [Deep continual learning for medical call incidents text classification under the presence of dataset shifts](https://www.sciencedirect.com/science/article/pii/S0010482524006322). Computers in Biology and Medicine, 175 (2024).

* Alessandro Bondielli, Pietro Dell'Oglio, Alessandro Lenci, Francesco Marcelloni, **Lucia Passaro** [Dataset for multimodal fake news detection and verification tasks](https://www.sciencedirect.com/science/article/pii/S2352340924004098) Data in Brief, 54 (2024).
* Debora Nozza, **Lucia C. Passaro**, Marco Polignano: [Special Issue NL4AI 2022: Workshop on natural language for artificial intelligence](https://content.iospress.com/articles/intelligenza-artificiale/ia230057). Intelligenza Artificiale 17(2): 159-161 (2023).
* Serena Auriemma, Mauro Madeddu, Martina Miliani, Alessandro Bondielli, Alessandro Lenci, **Lucia C. Passaro**: [Challenging Specialized Transformers on Zero-shot Classification](https://ceur-ws.org/Vol-3596/paper6.pdf). In: Proceedings of the 9th Italian Conference on Computational Linguistics, Venice, Italy, November 30 - December 2, 2023.
* Jacopo Gili, Lucia C. Passaro, Tommaso Caselli: [Check-IT!: A Corpus of Expert Fact-checked Claims for Italian](https://ceur-ws.org/Vol-3596/paper27.pdf). In: Proceedings of the 9th Italian Conference on Computational Linguistics, Venice, Italy, November 30 - December 2, 2023.
* A. Fantechi, S. Gnesi, **L. Passaro** and L. Semini [Inconsistency Detection in Natural Language Requirements using ChatGPT: a Preliminary Evaluation](https://ieeexplore.ieee.org/abstract/document/10260964) IEEE 31st International Requirements Engineering Conference (RE), Hannover, Germany, (2023).
* Alessandro Bondielli, Pietro Dell'Oglio, Alessandro Lenci, Francesco Marcelloni, **Lucia C. Passaro**, Marco Sabbatini: [MULTI-Fake-DetectiVE at EVALITA 2023: Overview of the MULTImodal Fake News Detection and VErification Task](https://ceur-ws.org/Vol-3473/paper32.pdf). In Proceedings of the Eighth Evaluation Campaign of Natural Language Processing and Speech Tools for Italian (EVALITA 2023). Parma, Italy, September 7th-8th, 2023.
* Pierluigi Cassotti, Lucia Siciliani, **Lucia C. Passaro**, Maristella Gatto, Pierpaolo Basile: [WiC-ITA at EVALITA2023: Overview of the EVALITA2023 Word-in-Context for ITAlian Task](https://ceur-ws.org/Vol-3473/paper46.pdf). In Proceedings of the Eighth Evaluation Campaign of Natural Language Processing and Speech Tools for Italian (EVALITA 2023). Parma, Italy, September 7th-8th, 2023.
* Serena Auriemma, Mauro Madeddu, Martina Miliani, Alessandro Bondielli, **Lucia C. Passaro**, Alessandro Lenci: [BureauBERTo: adapting UmBERTo to the Italian bureaucratic language](https://ceur-ws.org/Vol-3486/42.pdf). In Proceedings of the Italia Intelligenza Artificiale - Thematic Workshops co-located with the 3rd CINI National Lab AIIS Conference on Artificial Intelligence (Ital IA 2023). Pisa, Italy, May 29-30, 2023.
* **Lucia C. Passaro**, Alessandro Bondielli, Pietro Dell'Oglio, Alessandro Lenci, Francesco Marcelloni: [In-context annotation of topic-oriented datasets of fake news: A case study on the notre-dame fire event](https://www.sciencedirect.com/science/article/pii/S0020025522008167). Information Sciences. 615: 657-677 (2022)
